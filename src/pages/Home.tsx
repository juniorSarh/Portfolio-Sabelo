    ...
    <div>
        ...
        <main className={styles.hero}>
          <section className={styles.heroCard}>
            ...
            <p className={styles.subtitle}>Full-Stack Developer crafting clean, accessible solutions with React, TypeScript, Node.js, and .NET.</p>
            <div className={styles.actions}>
              <a href="/projects" className={styles.buttonPrimary} aria-label="View my projects">View Projects</a>
              <a href="/contact" className={styles.buttonGhost} aria-label="Get in touch">Get in touch</a>
            </div>
          </section>

          <section className={styles.visual}>
            <img src={codingImg} alt="Developer at work" className={styles.illustration} />
          </section>
        </main>
        <div className={styles.features}>
          <span className={styles.chip}>Full-stack developer</span>
          <span className={styles.chip}>IoT Facilitator</span>
          <span className={styles.chip}>Former IT Support</span>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.miniGrid}>
            <article className={styles.miniCard}>
              ...
              <a href="/projects" className={styles.miniLink} aria-label="See projects">See more →</a>
            </article>
            <article className={styles.miniCard}>
